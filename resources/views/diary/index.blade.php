...
@endsection 
	...
	<section class="container tm-home-section-1" id="more">
		<div class="row">
			...
			<div class="flexslider flexslider-about effect2">
			  <ul class="slides">
			    <li>
			      <img src="{{asset('img/about-1.jpg')}}" alt="image" />
			...
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="tm-about-box-1">
						<a href="#"><img src="{{asset('img/about-4.jpg')}}" alt="img" class="tm-about-box-1-img"></a>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="tm-about-box-1">
						<a href="#"><img src="{{asset('img/about-5.jpg')}}" alt="img" class="tm-about-box-1-img"></a>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="tm-about-box-1">
						<a href="#"><img src="{{asset('img/about-6.jpg')}}" alt="img" class="tm-about-box-1-img"></a>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="tm-about-box-1">
						<a href="#"><img src="{{asset('img/about-7.jpg')}}" alt="img" class="tm-about-box-1-img"></a>
				...
				<div class="col-lg-12">
					<div class="tm-what-we-do-right">
						<div class="tm-about-box-2 margin-bottom-30">
							<img src="{{asset('img/about-2.jpg')}}" alt="image" class="tm-about-box-2-img">
						...
						<div class="tm-about-box-2">
							<img src="{{asset('img/about-3.jpg')}}" alt="image" class="tm-about-box-2-img">
							<div class="tm-about-box-2-text">
	...
	<script type="text/javascript" src="{{asset('js/jquery-1.11.2.min.js')}}"></script>      		<!-- jQuery -->
  	...
  	<script type="text/javascript" src="{{asset('js/jquery.flexslider-min.js')}}"></script>			<!-- flexslider js -->
